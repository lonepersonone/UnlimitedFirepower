...
//		print(projectileParticleName);
	...
	public void getProjectileNames()			// Find and diplay the name of the currently selected projectilePrefab
	{
		// Access the currently selected projectilePrefab's 'ProjectileScript'
		projectileScript = effectScript.projectiles[effectScript.currentProjectile].GetComponent<ETFXProjectileScript>();
		projectileParticleName = projectileScript.projectileParticle.name;	// Assign the name of the currently selected projectilePrefab to projectileParticleName
	}
