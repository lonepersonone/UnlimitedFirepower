...
namespace Michsky.UI.Reach
{
    ...
    public class PauseMenuManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            setTimeScale.boolValue = ReachUIEditorHandler.DrawToggle(setTimeScale.boolValue, customSkin, "Set Time Scale", "Sets the time scale depending on the Pauseable menu state.");
