        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < lsTarget.languages.Count; i++)
            {
                ...
                if (lsTarget.languages[i].isExpanded)
                {
                    ...
                    lsTarget.languages[i].languageName = EditorGUILayout.TextField("Language PowerCN", lsTarget.languages[i].languageName);
                    lsTarget.languages[i].localizedName = EditorGUILayout.TextField("Localized PowerCN", lsTarget.languages[i].localizedName);
