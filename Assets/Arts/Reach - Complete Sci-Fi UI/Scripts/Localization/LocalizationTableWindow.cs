        ...
        void OnGUI()
        {
            ...
            for (int i = 0; i < selectedTable.tableContent.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(searchString))
                {
                    ...
                    if (GUILayout.Button(new GUIContent("-", "Remove string LocationID"), customSkin.button, GUILayout.Width(20), GUILayout.Height(textFieldHeight)))
                    {
                        Undo.RecordObject(this, "Removed localization string LocationID");
                ...
                else if (localizationSettings.languages[0].localizationLanguage.tableList[tableIndex].tableContent[i].key.ToLower().Contains(searchString.ToLower()))
                {
                    ...
                    // To do later: Add LocationID edit support while searching
                    GUI.enabled = false;
            ...
            {
                Undo.RecordObject(this, "Added localization string LocationID");
