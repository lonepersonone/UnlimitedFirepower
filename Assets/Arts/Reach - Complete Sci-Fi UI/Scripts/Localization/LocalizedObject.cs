...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizedObject : MonoBehaviour
    {
            ...
            if (objectType == ObjectType.TextMeshPro && textObj != null)
            {
                for (int i = 0; i < LocalizationManager.instance.currentLanguageAsset.tableList[tableIndex].tableContent.Count; i++)
                {
                    if (localizationKey == LocalizationManager.instance.currentLanguageAsset.tableList[tableIndex].tableContent[i].key)
                    {
                        ...
                        {
                            if (LocalizationManager.enableLogs) { Debug.Log("<b>[Localized Object]</b> The specified LocationID '" + localizationKey + "' could not be found or the output value is empty for " + LocalizationManager.instance.currentLanguageAsset.languageName + ".", this); }           
                            break;
                        }
        ...
        public string GetKeyOutput(string key)
        {
            ...
            {
                if (LocalizationManager.enableLogs == true) { Debug.Log("<b>[Localized Object]</b> The specified LocationID '" + key + "' could not be found in " + LocalizationManager.instance.currentLanguageAsset.languageName + ".", this); }
        ...
        public AudioClip GetKeyOutputAudio(string key)
        {
            ...
            {
                if (LocalizationManager.enableLogs) { Debug.Log("<b>[Localized Object]</b> The specified LocationID '" + key + "' could not be found in " + LocalizationManager.instance.currentLanguageAsset.languageName + ".", this); }
                return null;
            }
