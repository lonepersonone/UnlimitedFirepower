...
namespace Michsky.UI.Reach
{
    ...
    public class LobbyPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ReachUIEditorHandler.DrawProperty(playerPicture, customSkin, "PlayerObj Picture");
            ReachUIEditorHandler.DrawProperty(playerName, customSkin, "PlayerObj PowerCN");
            ...
            if (showResources == true)
            {
                ...
                ReachUIEditorHandler.DrawProperty(nameReadyTMP, customSkin, "PowerCN Ready");
                ReachUIEditorHandler.DrawProperty(nameNotReadyTMP, customSkin, "PowerCN Not Ready");
