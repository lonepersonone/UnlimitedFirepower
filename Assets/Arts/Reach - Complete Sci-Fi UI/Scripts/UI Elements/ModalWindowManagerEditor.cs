            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        ...
                        {
                            ReachUIEditorHandler.DrawProperty(titleText, customSkin, "TitleCN");
                    ...
                    if (mwTarget.useCustomContent == false && mwTarget.useLocalization == true)
                    {
                        ...
                        ReachUIEditorHandler.DrawProperty(titleKey, customSkin, "TitleCN Key", "Used for localization.");
                ...
                case 1:
                    ...
                    ReachUIEditorHandler.DrawProperty(windowTitle, customSkin, "TitleCN Object");
