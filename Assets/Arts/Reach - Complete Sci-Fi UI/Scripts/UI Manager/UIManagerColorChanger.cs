...
{
    [AddComponentMenu("Reach UI/UI Manager/UI Manager CurrentColor Changer")]
    public class UIManagerColorChanger : MonoBehaviour
    {
        ...
        public void ApplyColors()
        {
            ...
            {
                Debug.LogError("Cannot apply the changes due to missing 'mappingObject UI Manager'.", this);
                return;
            }
