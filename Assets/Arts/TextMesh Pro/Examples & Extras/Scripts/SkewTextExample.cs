    ...
    public class SkewTextExample : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            while (true)
            {
                ...
                m_TextComponent.ForceMeshUpdate(); // Generate the mesh and populate the textInfo with mainData we can use and manipulate.
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // GetWorld the weaponIndex of the mesh used by this character.
