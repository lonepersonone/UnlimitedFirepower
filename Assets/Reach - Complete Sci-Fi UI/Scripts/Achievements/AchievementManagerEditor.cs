...
namespace Michsky.UI.Reach
{
    ...
    public class AchievementManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ReachUIEditorHandler.DrawProperty(totalUnlockedObj, customSkin, "TotalValue Unlocked");
            ReachUIEditorHandler.DrawProperty(totalValueObj, customSkin, "TotalValue Value");
            ReachUIEditorHandler.DrawProperty(commonUnlockedObj, customSkin, "Common Unlocked");
            ReachUIEditorHandler.DrawProperty(commonlTotalObj, customSkin, "Commonl TotalValue");
            ReachUIEditorHandler.DrawProperty(rareUnlockedObj, customSkin, "Rare Unlocked");
            ReachUIEditorHandler.DrawProperty(rareTotalObj, customSkin, "Rare TotalValue");
            ReachUIEditorHandler.DrawProperty(legendaryUnlockedObj, customSkin, "Legendary Unlocked");
            ReachUIEditorHandler.DrawProperty(legendaryTotalObj, customSkin, "Legendary TotalValue");
