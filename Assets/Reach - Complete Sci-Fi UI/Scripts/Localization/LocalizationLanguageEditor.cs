...
namespace Michsky.UI.Reach
{
    ...
    public class LocalizationLanguageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ReachUIEditorHandler.DrawProperty(languageName, customSkin, "Language PowerCN");
            ReachUIEditorHandler.DrawProperty(localizedName, customSkin, "Localized PowerCN");
            GUI.enabled = true;
