        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (buttonTarget.latestTabIndex)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        ...
                        if (buttonTarget.titleObj != null)
                        {
                            ...
                            enableTitle.boolValue = ReachUIEditorHandler.DrawTogglePlain(enableTitle.boolValue, customSkin, "Enable TitleCN");
                ...
                case 1:
                    ...
                    ReachUIEditorHandler.DrawProperty(titleObj, customSkin, "TitleCN Object");
