...
namespace Michsky.UI.Reach
{
    ...
    public class UIManagerImageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                ReachUIEditorHandler.DrawProperty(colorType, customSkin, "CurrentColor Type");
                useCustomColor.boolValue = ReachUIEditorHandler.DrawToggle(useCustomColor.boolValue, customSkin, "Use Custom CurrentColor");
