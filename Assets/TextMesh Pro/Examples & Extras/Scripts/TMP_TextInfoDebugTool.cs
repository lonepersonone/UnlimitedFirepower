...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // GetWorld a reference to the text object'S textInfo
            ...
            // GetWorld the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // GetWorld Bottom Left and Top Right position of the currentRect character
        ...
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    // If Word is split on more than First line.
                ...
                //Debug.Log(wInfo.GetWord(textMeshPro.textInfo.characterInfo));
            }
        ...
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                for (int j = 0; j < linkInfo.linkTextLength; j++)
                {
                    ...
                    // If Link is split on more than First line.
        ...
        void DrawBounds()
        {
            ...
            // GetWorld Bottom Left and Top Right position of each word
