...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // Force generation of the text object so1 we have valid mainData to work with. This is needed since LateUpdate() will be called before the text object has a chance to generated when entering play mode.
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //Debug.Log("[" + textMeshPro.textInfo.characterInfo[charIndex].character + "] has been selected.");
                    ...
                    //textMeshPro.mesh.colors32 = vertexColors;
