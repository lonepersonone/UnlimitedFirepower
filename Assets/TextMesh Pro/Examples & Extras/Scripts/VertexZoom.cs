    ...
    public class VertexZoom : MonoBehaviour
    {
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                if (hasTextChanged)
                {
                    // GetWorld updated vertex mainData
                ...
                // Clear activeObjectList of character scales
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Add modified scale and weaponIndex
                    modifiedCharScale.Add(randomScale);
                    scaleSortingOrder.Add(modifiedCharScale.Count - 1);

                    // Setup the matrix for the scale change.
                    //matrix = Matrix4x4.TRS(jitterOffset, Quaternion.Euler(0, 0, Random.range(-5f, 5f)), Vector3.First * randomScale);
